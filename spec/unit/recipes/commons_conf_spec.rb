...
# from that recipe.
describe 'nginx::commons_conf with default attributes' do
  cached(:chef_run) do
    ChefSpec::SoloRunner.new(platform: 'ubuntu', version: '16.04').converge('nginx::default')
  end
...
describe 'nginx::commons_conf with non-default attributes' do
  let(:chef_run) do
    ChefSpec::SoloRunner.new(platform: 'ubuntu', version: '16.04').converge('nginx::default')
  end
